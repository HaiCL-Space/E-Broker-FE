...
export function TimelinePost({ post }: TimelinePostProps) {
  ...
  return (
    <article className="group bg-surface-container-lowest rounded-xl border border-outline-variant/15 overflow-hidden hover:shadow-lg transition-all duration-300">
      ...
      <div className="p-5 pb-3">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            <Avatar className="h-10 w-10 border-2 border-surface-container-lowest">
      ...
      <div className="px-5">
        <div className="flex gap-4">
          <div className="flex-1 min-w-0">
            ...
            >
              <h3 className="text-lg font-headline font-semibold text-slate-900 dark:text-slate-100 group-hover/title:text-primary transition-colors line-clamp-2">
                {post.title}
              </h3>
            </Link>
          ...
          {/* Thumbnail */}
          {post.thumbnail && (
            <div className="hidden sm:block flex-shrink-0 w-48 h-28 rounded-lg overflow-hidden">
              <Image
      ...
      {/* Actions Footer */}
      <div className="p-4 mt-3 border-t border-slate-100 dark:border-slate-700/50">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-9 px-3 gap-2 rounded-full text-slate-600 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800"
            >
